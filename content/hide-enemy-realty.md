...
draft: false
description: "Скрывает недвижимость противника на рынке ресурсов и добавляет сортировку на страницах рынка и синдиката GWars."
tags:
  - Ресурсы
  - Сортировка
---
...
<div class="script-layout">
  <section class="script-card script-header">
    <div class="script-intro">
      <p>Скрывает недвижимость противника на рынке ресурсов и добавляет сортировку на страницах рынка и синдиката.</p>
      <span class="info-chip"><strong>Версия:</strong> 0.5</span>
    </div>

  <div class="script-actions">
      <a class="cta-primary" href="./GWars-HideEnemyRealtyOnMarket.user.js">Установить скрипт</a>
      <a class="cta-secondary" href="https://github.com/KOMB4T/komb4t.github.io/blob/refs/heads/v4/content/scripts/GWars-HideEnemyRealtyOnMarket.user.js?plain=1" rel="noreferrer noopener">Открыть raw-версию</a>
    </div>
  </section>
  ...
  <section class="script-card script-section">
    ...
    <ul class="feature-list">
      <li>На странице рынка ресурсов (<code>statlist.php</code>): переносит зачёркнутые объекты (недвижимость противника) в конец таблицы и выделяет их серым фоном.</li>
      <li>На странице рынка: добавляет панель сортировки активных позиций — по удалённости (близкие объекты выше), по объёму (по убыванию) или по цене (по возрастанию). По умолчанию используется сортировка по цене.</li>
      <li>На странице синдиката (<code>syndicate.php</code>): добавляет выпадающий список сортировки контролируемой недвижимости — по умолчанию (исходный порядок) или по зарплате (объекты с зарплатой выше, по убыванию).</li>
      <li>Запоминает выбранный режим сортировки в <code>localStorage</code> отдельно для каждой таблицы, чтобы настройки сохранялись между посещениями.</li>
      <li>Аккуратно встраивается только на страницах <code>statlist.php</code> и <code>syndicate.php</code>, не затрагивая другие страницы.</li>
    </ul>
  </section>
