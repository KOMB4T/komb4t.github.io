---
title: "[GWars] Hide Enemy Realty on Market"
permalink: hide-enemy-realty
aliases:
...
<div class="script-layout">
  ...
  <div class="script-actions">
      <a class="cta-primary" href="./%5BGWars%5DHideEnemyRealtyOnMarket.user.js">Установить скрипт</a>
      <a class="cta-secondary" href="https://komb4t.github.io/scripts/%5BGWars%5DHideEnemyRealtyOnMarket.user.js" target="_blank" rel="noreferrer noopener">Открыть raw-версию</a>
    </div>
  </section>
  ...
  <section class="script-gallery">
    <figure>
      <img src="./screenshot-1.png" alt="Сортировка на рынке ресурсов GWars" loading="lazy" />
