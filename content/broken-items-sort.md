...
draft: false
description: "Улучшенная сортировка предметов: приоритет для сломанных/истекших, группировка дубликатов по item_tag с возможностью показать/скрыть, сортировка в панели NPC"
tags:
  - Предметы
  - Сортировка
---
...
<div class="script-layout">
  <section class="script-card script-header">
    <div class="script-intro">
      <p>Улучшенная сортировка предметов: автоматически поднимает сломанные и истекшие предметы в начало списка, группирует дубликаты по item_tag с возможностью показать/скрыть кликом по счетчику, а также сортирует панель NPC. Автоматически обновляется при изменениях на странице.</p>
  ...
  <div class="script-actions">
      ...
      <a class="cta-secondary" href="https://github.com/KOMB4T/komb4t.github.io/blob/refs/heads/v4/content/scripts/Gwars-BrokenItemsSort.user.js?plain=1" rel="noreferrer noopener">Открыть raw-версию</a>
    </div>
  </section>
  ...
  <section class="script-card script-section">
    ...
    <ul class="feature-list">
      ...
      <li>Группирует дубликаты предметов по <code>item_tag</code> (или <code>item_id</code>), скрывает их и показывает счетчик количества (например, ×3).</li>
      <li>Позволяет показать или скрыть дубликаты кликом по счетчику рядом с названием предмета.</li>
      <li>Группирует строки одного предмета (например, <code>item_tr1_X</code> и <code>item_tr2_X</code>) и перемещает их вместе.</li>
      <li>Сортирует панель отправки NPC, поднимая строки с красным шрифтом (приоритетные) в начало списка.</li>
