  ...
  <section class="script-card catalog-list">
    ...
    <div class="script-catalog">
      ...
      <article class="script-card" data-tags="Ресурсы,Сортировка">
        ...
        <p>Опускает недвижимость противника в конец таблицы на рынке ресурсов и добавляет сортировку активных позиций по удалённости, объёму или цене. На странице синдиката позволяет сортировать контролируемую недвижимость по зарплате.</p>
        <ul class="tag-list">
          <li># Ресурсы</li>
          <li># Сортировка</li>
        </ul>
